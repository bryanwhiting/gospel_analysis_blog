...
description: |
  ...
  referred to in 41% of all Book of Mormon scriptures. Read to see
  which General Conference speaker holds the record for the most references
  to Christ in a single talk.
author:
  - name: Bryan Whiting
