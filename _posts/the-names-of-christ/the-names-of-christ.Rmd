...
text <- insta_text(
  "41%",
  "41% of verses in The Book of Mormon: Another Testament of Jesus Christ have at least one reference to **Jesus Christ**",
)
...
p <- instaquote(
  text = insta_text(
    "100",
    "The number of names for Jesus Christ<br>in The Book of Mormon: Another Testament of Jesus Christ",
  ), bg_color = colors[4]
)
photopost(
  p,
  caption = "What's your favorite name for Christ?",
  slug = slug,
